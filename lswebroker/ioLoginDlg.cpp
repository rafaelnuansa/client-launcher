...
void ioLoginDlg::OnBnClickedLogin()
{
	...
	std::string mainkey = "lsx";
	std::string apikey = "RFLSNeWrEBO3Xnz"; // put your key here 
	...
	if (httpCode == 200) {
		...
		string losakey = "EDEW3940FVDP4950,10,20,30,1,autoupgrade_info.ini,-1,0,1,119483910,?" + encodefix + encidfix + "?0?" + gameserverid + "?2020,09,10,0";
...
{
	//system("start http://lsxtension.com/");
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
#ifdef SRC_KOR
	SetBitmap( IDB_BACK_UI );         // set background bitmap
